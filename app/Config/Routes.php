...
$routes->add('konsultasi', 'Konsultasi::create');
$routes->match(['get', 'post'], 'konsultasi/kirim', 'Konsultasi::kirim');
// $routes->get('konsultasi', 'KirimEmail::index', ['as' => 'konsultasiForm']);
