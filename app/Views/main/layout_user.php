...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/dist/css/footer.css">
  <!-- Sweet Alerts -->
...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-info" style="font-weight: bold;">
    <div class="container">
      <a class="navbar-brand" href="<?= site_url('main/home'); ?>">KMS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('main/listdata'); ?>">List Barang</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('chat/index'); ?>">Chat</a>
          </li>
