    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="cari" placeholder="Silahkan Cari Barang berdasarkan Kode Barang / Nama Barang" id="cari">
...
<script>
  function cariDataBarang() {
    ...
    $.ajax({
      ...
      dataType: "json",
      beforeSend: function() {
        $('.viewdetaildata').html('<i class="fa fa-spin fa-spinner text-info"></i>');
      },
